...
// only characters 32 (' ') to 126 ('~') are included
...
// Draws a single character to the screen, with scale/background color/foreground color specified.
...
// Draws a piece of null-terminated text to the screen
